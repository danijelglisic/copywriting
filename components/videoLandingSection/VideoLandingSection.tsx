...
const VideoLandingSection = ({ props }: VideoLandingSectionProps) => {
  ...
  return (
    <div className="bg-secondary bg-opacity-80 relative text-white">
      ...
      />
      <div className="container py-28 flex flex-col lg:flex-row gap-8 lg:gap-12 lg:[&>*]:w-1/2 justify-between items-center">
        ...
        <div className="flex flex-col gap-16">
          <h1 className="heading-1 hidden lg:block">{title}</h1>
